...
export default function HeroSection() {
  ...
  return (
    <section className="flex flex-col lg:flex-row items-center lg:items-stretch justify-start lg:justify-center gap-8 lg:gap-8 px-4 sm:px-8 pt-12 pb-20 lg:pt-0 lg:pb-0 lg:min-h-screen border-b border-amber-900/20">
      ...
      {/* Left: text + button */}
      <div className="flex flex-col justify-center items-center lg:items-start text-center lg:text-left max-w-lg lg:flex-[2] lg:py-16">
        <h1
      ...
      <div className="hidden lg:block relative rounded-2xl overflow-hidden shadow-xl lg:flex-[3] lg:max-w-[640px]">
        {SETS.map((s, idx) => (
          <div
            key={s.label + "-after"}
            className="absolute inset-0 transition-opacity duration-1000"
