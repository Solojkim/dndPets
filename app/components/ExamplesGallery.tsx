...
function ComingSoonCard() {
  return (
    <div className="w-full aspect-square relative rounded-2xl shadow-lg overflow-hidden" style={{ backgroundColor: "#ede0c4" }}>
        ...
        {EXAMPLES.map((example) => (
          <div key={example.class} className="flex flex-col items-center gap-2">
            {example.comingSoon ? (
              ...
              <div className="w-full aspect-square relative rounded-2xl shadow-lg overflow-hidden">
                <Image
                  src={example.src}
                  alt={example.alt}
                  fill
